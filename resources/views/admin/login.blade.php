...
<html
  ...
  <head>
	...
	<link rel="stylesheet" href="/admin/assets/css/flag-icons.css" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="/admin/assets/css/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="/admin/assets/css/theme-default.css" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="/admin/assets/css/demo.css" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="/admin/assets/css/perfect-scrollbar.css" />
    <link rel="stylesheet" href="/admin/assets/css/typeahead.css" />
    <!-- Vendor -->
	<link rel="stylesheet" href="/admin/assets/css/index.min.css" />
	<link rel="stylesheet" href="/admin/assets/css/page-auth.css" />
  ...
  <body>
    ...
    <script src="/admin/assets/js/hammer.js"></script>
    <script src="/admin/assets/js/i18n.js"></script>
    ...
    <!-- Vendors JS -->
    <script src="/admin/assets/js/popular.min.js"></script>
    <script src="/admin/assets/js/index.min.js"></script>
